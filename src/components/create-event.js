  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      <div>
        ...
        {/* Replace the value below with the organizer ID */}
        <input type="text" name="organizer_id" value={organizer.id} onChange={handleChange} className="w-full px-3 py-2 border border-gray-300 rounded" />
      </div>
      {/* Add similar input fields for the other properties here */}
      <div>
